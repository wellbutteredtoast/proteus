Proteus
-----------------
<img align="left" style="width:64px" src="./static/ProteusLogo01.png" width="64px">

Proteus is a passion project, general purpose game engine implemented in C++. It's designed at its core to be simple, yet powerful. It's also designed to be extremely efficient on the CPU and GPU.
...
So, _why?_ Well, I've personally had problems with the major game engines that I struggle to get past:
 ...
 2. I no longer wish to support Unity after losing trust in the company over the 2023 runtime fee mess.

Thus, Proteus. My solution, a code-focused game engine that _just works_.
